...
# this folder is used to save the image
    ...
    for listOfMatchingChars in listOfListsOfMatchingChars:
        ...
        cv2.imwrite('./NumberPlate.jpg',imgCropped)
        imgT = imgCropped
...
def plateDetect(img,img2,imgk):
    ...
    for con in contours:
        ...
        if ratio>1 and ratio<5 and area>=2000 and area<=80000:
            ...
            cv2.imwrite('/home/karen/Documents/Project Sem 8/FinalProject/SIFT/flickr_logos_27_dataset/flickr_logos_27_dataset_images/logo.jpg',logo)
